...
<?php include 'header.php'; ?>
	...
	<p class="introtext">
		<span class="nobreak">저희 행사의 마스코트, </span>
	...
	<div class="normaltext flexrow mobile-pivot-late" style="margin-top:-12px;gap:4px;">
		...
		<a class="actual_link link_with_icon" href="images/Hanmari_CM_rev1_3000px.png" download>
			큐티마크(PNG)
			<img src="sprites/download_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24_FILLDP.png"
				width="20px" height="20px">
		</a>
		<a class="actual_link link_with_icon" href="images/hanmari_CM_rev1_TRIM.svg" download>
			큐티마크(SVG)
			<img src="sprites/download_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24_FILLDP.png"
				width="20px" height="20px">
		</a>
