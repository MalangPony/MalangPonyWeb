...
<?php include 'header.php'; ?>
	...
	<table class="timetable">
		...
		<tr class="tt_row">
			...
			<td class="tt_block tt_block_red" style="height:2lh;">
				<div class="tt_trange">10:00 -</div>
				<div class="tt_actname">참가자 입장 시작</div>
			</td>
			<td class="tt_expl">10시~11시 아무때나 입장해 주시면 됩니다.</td>
		</tr>
		<tr class="tt_row">
			<td class="tt_time">11:30</td>
			<td class="tt_block tt_block_yellow" style="height:2lh;">
		...
		<tr class="tt_row">
			...
			<td class="tt_block tt_block_blue" style="height:3lh;">
				<div class="tt_trange">11:30 - 13:00</div>
				<div class="tt_actname">우리말 겨루기!</div>
			</td>
			<td class="tt_expl">마이리틀포니 지식 퀴즈쇼</td>
		</tr>
		<tr class="tt_row">
			<td class="tt_time">14:30</td>
			<td class="tt_block tt_block_purple" style="height:3lh;">
				<div class="tt_trange">13:00 - 14:30</div>
				<div class="tt_actname">드로잉 쇼 &amp; 다과회</div>
			</td>
			<td class="tt_expl">아티스트들의 그림 실력을 구경하면서<br>맛있는 과자를 먹읍시다</td>
		</tr>
		<tr class="tt_row">
			<td class="tt_time">15:00</td>
			<td class="tt_block tt_block_red" style="height:3lh;">
		...
		<tr class="tt_row">
			...
			<td class="tt_block tt_block_yellow" style="height:5lh;">
		...
		<tr class="tt_row">
			...
			<td class="tt_block tt_block_blue" style="height:2lh;">
